  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <Link
          href="/chat"
          className="inline-flex items-center gap-2 text-sm text-zinc-500 dark:text-zinc-400 hover:text-[#6c47ff] mb-6 transition-colors"
        >
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col gap-2">
                <button
                  onClick={() => user?.update && (window as unknown as { Clerk?: { openUserProfile: () => void } }).Clerk?.openUserProfile()}
                  className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-[#6c47ff] border border-[#6c47ff] rounded-lg hover:bg-[#6c47ff]/5 transition-colors"
                >
                  Edit Profile
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-zinc-600 dark:text-zinc-400 border border-zinc-200 dark:border-zinc-700 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-800 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors"
                >
